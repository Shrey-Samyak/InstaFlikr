...
public class PhotosListFragment extends SherlockFragment implements InitialSetup {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		View v;
		v = inflater.inflate(R.layout.photos_grid_fragment, container, false);
		if(v != null)
			return v;
	...
	public void onViewCreated(View view, Bundle savedInstanceState) {
		...
		//Codigo chamado quando um o utilizador carrega num item do grid
		...
		//Codigo chamado quando um utilizador faz scroll da gridview que contem as fotos
		...
		//Codigo chamado quando o utilizador quer pesquisar algo no Flickr
